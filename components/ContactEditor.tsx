...
export default function ContactEditor({ formData, setFormData }: Props) {
  ...
  return (
    <div className="space-y-4">
      ...
      <label>
        <span className="block font-medium">📧 Email de réception des messages</span>
        <input
          type="email"
          value={contact.emailDestination || ''}
          onChange={(e) => handleChange('emailDestination', e.target.value)}
          className="w-full border px-3 py-2 rounded"
